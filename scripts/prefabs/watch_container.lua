...
local function OnOpen(inst)
    ...
    inst.components.inventoryitem:ChangeImageName("watch_container_open")
...
local function OnHaunt(inst, haunter)
    if haunter ~= nil and haunter:HasTag("pocketwatchcaster") then
        inst.components.container:DropEverything()
        return true
    end
    return false
...
local floatable_swap_data = { bank = "watch_container", anim = "closed" }
...
local function fn()
    ...
    --inst.MiniMapEntity:SetIcon("watch_container.png")

    inst.AnimState:SetBank("watch_container")
    inst.AnimState:SetBuild("watch_container")
    inst.AnimState:PlayAnimation("closed")
    ...
    inst.components.container:WidgetSetup("watch_container")
...
return Prefab("watch_container", fn, assets, prefabs)